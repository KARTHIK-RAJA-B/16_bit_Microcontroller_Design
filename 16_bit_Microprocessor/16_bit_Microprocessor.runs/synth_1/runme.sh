...
HD_PWD='C:/Users/karth/RISC_MicroProcessor/RISC_MicroProcessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_Risc_16_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_Risc_16_bit.tcl
