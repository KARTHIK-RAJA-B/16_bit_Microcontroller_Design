...
HD_PWD='C:/Users/karth/RISC_MicroProcessor/RISC_MicroProcessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_Risc_16_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_Risc_16_bit.tcl -notrace
